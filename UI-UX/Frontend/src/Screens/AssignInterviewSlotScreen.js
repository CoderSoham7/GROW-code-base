...
import { getDriveAndSlot } from "../Actions/UserActions.js"; // Updated import
import AssignInterviewSlotTable from "../Components/AssignInterviewSlotTable.js"
import swal from 'sweetalert';

const AssignInterviewSlotScreen = () => {
  ...
  return (
    <div className="minheight white">
      <Container>
        <Link className='btn btn-outline-light my-3 py-2' to='/'>
        ...
        <Alert className='grad'>
          <h4 className='white text-center text-capitalize mb-0'>
            Interview Date and Time Slot Assignment
          </h4>
        </Alert>
        ...
        {showTable && !loading && !error && (
          <Row className="mb-5">
            <AssignInterviewSlotTable driveAndSlotList={driveAndSlotList} />
          </Row>
        )}
...
export default AssignInterviewSlotScreen;